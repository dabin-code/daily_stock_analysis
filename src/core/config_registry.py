...
_CATEGORY_DEFINITIONS: List[Dict[str, Any]] = [
    ...
    },
    {
        "category": "screening",
        "title": "Screening",
        "description": "Full-market screening thresholds, lookbacks, and candidate limits.",
        "display_order": 35,
    },
    {
...
_FIELD_DEFINITIONS: Dict[str, Dict[str, Any]] = {
    ...
    "SCREENING_CANDIDATE_LIMIT": {
        "title": "Screening Candidate Limit",
        "description": "Maximum number of rule-screened candidates kept for a single run.",
        "category": "screening",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SCREENING_DEFAULT_MODE": {
        "title": "Screening Default Mode",
        "description": "Default preset for full-market screening. Balanced keeps current thresholds, aggressive broadens the pool, quality tightens it.",
        "category": "screening",
        "data_type": "string",
        "ui_control": "select",
        "is_sensitive": False,
        ...
        "options": ["balanced", "aggressive", "quality"],
        "validation": {"enum": ["balanced", "aggressive", "quality"]},
        "display_order": 5,
    },
    "SCREENING_AI_TOP_K": {
        "title": "Screening AI Top K",
        "description": "Maximum number of top-ranked candidates sent to AI secondary screening.",
        "category": "screening",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SCREENING_MIN_FINAL_SCORE": {
        "title": "Screening Min Final Score",
        "description": (
            "Final-layer score gate applied after L1-L5 rerank. "
            "Candidates whose post-rerank rule_score (the persisted final_score) "
            "falls below this threshold are dropped from the final selection. "
            "Default 80 keeps only high-quality picks; set 0 to disable."
        ),
        "category": "screening",
        "data_type": "number",
        "ui_control": "number",
    ...
    "SCREENING_SCHEDULE_ENABLED": {
        "title": "Screening Schedule Enabled",
        "description": "Enable the independent daily full-market screening schedule.",
        "category": "screening",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SCREENING_SCHEDULE_TIME": {
        "title": "Screening Schedule Time",
        "description": "Daily full-market screening schedule time in HH:MM format.",
        "category": "screening",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
    ...
    "SCREENING_SCHEDULE_RUN_IMMEDIATELY": {
        "title": "Screening Schedule Run Immediately",
        "description": "Whether to run one full-market screening immediately on schedule process startup.",
        "category": "screening",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "SCREENING_MIN_LIST_DAYS": {
        "title": "Screening Min List Days",
        "description": "Minimum number of listed days required before a stock can enter the candidate pool.",
        "category": "screening",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SCREENING_MIN_VOLUME_RATIO": {
        "title": "Screening Min Volume Ratio",
        "description": "Minimum volume ratio required by the rule screener.",
        "category": "screening",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "SCREENING_BREAKOUT_LOOKBACK_DAYS": {
        "title": "Screening Breakout Lookback Days",
        "description": "Lookback window used when computing near-breakout signals.",
        "category": "screening",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
        ...
        "default_value": "20",
        "options": [],
        "validation": {"min": 2, "max": 240},
        "display_order": 60,
    },
    "SCREENING_FACTOR_LOOKBACK_DAYS": {
        "title": "Screening Factor Lookback Days",
        "description": "Historical window used when building factor snapshots for screening.",
        "category": "screening",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "FEISHU_CHAT_ID": {
        ...
        "description": "Feishu group chat ID for app-based proactive notifications.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
    ...
    "FEISHU_VERIFICATION_TOKEN": {
        ...
        "description": "Verification token for Feishu event-subscription callback mode. Optional in Stream mode.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "FEISHU_ENCRYPT_KEY": {
        ...
        "description": "Encrypt key for Feishu encrypted event payloads. Optional in Stream mode.",
        "category": "notification",
        "data_type": "string",
        "ui_control": "password",
        "is_sensitive": True,
    ...
    "FEISHU_STREAM_ENABLED": {
        ...
        "description": "Enable Feishu Stream (WebSocket) bot mode. Recommended for local or Docker deployments because it does not require a public callback URL.",
        "category": "notification",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "KLINE_GOVERNANCE_ENABLED": {
        "title": "K-Line Governance Enabled",
        "description": "Enable the daily K-line governance workflow.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "KLINE_GOVERNANCE_SCHEDULE_TIME": {
        "title": "K-Line Governance Schedule Time",
        "description": "Daily HH:MM schedule time for the K-line governance workflow.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
    ...
    "KLINE_GOVERNANCE_RUN_IMMEDIATELY": {
        "title": "K-Line Governance Run Immediately",
        "description": "Run one K-line governance cycle immediately on startup when enabled.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "KLINE_AUDIT_LOOKBACK_DAYS": {
        "title": "K-Line Audit Lookback Days",
        "description": "Trading-day lookback window used by the daily K-line audit.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "KLINE_DEEP_AUDIT_LOOKBACK_DAYS": {
        "title": "K-Line Deep Audit Lookback Days",
        "description": "Historical lookback window used by the low-frequency deep audit.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "KLINE_DEEP_AUDIT_SCHEDULE_ENABLED": {
        "title": "K-Line Deep Audit Schedule Enabled",
        "description": "Enable the independent low-frequency deep audit schedule.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "KLINE_DEEP_AUDIT_SCHEDULE_TIME": {
        "title": "K-Line Deep Audit Schedule Time",
        "description": "HH:MM schedule time for the independent deep audit job.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
    ...
    "KLINE_RETRY_MAX_ATTEMPTS": {
        "title": "K-Line Retry Max Attempts",
        "description": "Maximum retry attempts before a K-line gap becomes a skip candidate.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "KLINE_SKIP_CANDIDATE_FAILURE_THRESHOLD": {
        "title": "K-Line Skip Candidate Failure Threshold",
        "description": "Number of failed repair attempts required before promoting a gap to candidate_skip.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "KLINE_AUDIT_AUTO_SKIP_ENABLED": {
        "title": "K-Line Audit Auto Skip Enabled",
        "description": "Allow small skip-eligible symbol gaps to be automatically approved after daily audit.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "KLINE_AUDIT_AUTO_SKIP_MAX_SYMBOLS": {
        "title": "K-Line Audit Auto Skip Max Symbols",
        "description": "Maximum number of symbols that may be auto-approved in one daily governance run.",
        "category": "system",
        "data_type": "integer",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "KLINE_AUDIT_AUTO_SKIP_MAX_RATIO": {
        "title": "K-Line Audit Auto Skip Max Ratio",
        "description": "Maximum auto-approved symbol ratio relative to the expected daily universe.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "KLINE_AUDIT_AUTO_SKIP_MIN_COVERAGE": {
        "title": "K-Line Audit Auto Skip Min Coverage",
        "description": "Minimum successful coverage required before small K-line gaps can be auto-approved.",
        "category": "system",
        "data_type": "number",
        "ui_control": "number",
        "is_sensitive": False,
    ...
    "KLINE_AUDIT_AUTO_SKIP_REASON_CLASSES": {
        "title": "K-Line Audit Auto Skip Reason Classes",
        "description": "Comma-separated reason_class allowlist for auto-approved K-line gaps.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "skip_eligible",
        "options": [],
        "validation": {},
        "display_order": 26,
    },
    "KLINE_AUDIT_AUTO_SKIP_REASONS": {
        "title": "K-Line Audit Auto Skip Reasons",
        "description": "Comma-separated reason allowlist for auto-approved K-line gaps.",
        "category": "system",
        "data_type": "string",
        "ui_control": "text",
        "is_sensitive": False,
        "is_required": False,
        "is_editable": True,
        "default_value": "not_in_bulk_universe,empty_data",
        "options": [],
        "validation": {},
        "display_order": 27,
    },
    "BOARD_SYNC_SCHEDULE_ENABLED": {
        "title": "Board Sync Schedule Enabled",
        "description": "Enable daily scheduled board membership sync after market close.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
    ...
    "BOARD_SYNC_SCHEDULE_TIME": {
        "title": "Board Sync Schedule Time",
        "description": "Daily time in HH:MM format for scheduled board membership sync.",
        "category": "system",
        "data_type": "time",
        "ui_control": "time",
        "is_sensitive": False,
    ...
    "BOARD_SYNC_RUN_IMMEDIATELY": {
        "title": "Board Sync Run Immediately",
        "description": "Whether to run one board membership sync immediately on startup in schedule mode.",
        "category": "system",
        "data_type": "boolean",
        "ui_control": "switch",
        "is_sensitive": False,
