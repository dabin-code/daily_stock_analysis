...
import { BarChart3, BriefcaseBusiness, Database, Home, LogOut, MessageSquareQuote, ScanSearch, Settings2 } from 'lucide-react';
...
const NAV_ITEMS: NavItem[] = [
  ...
  { key: 'data-health', label: '数据健康', to: '/data-health', icon: Database },
  { key: 'screening', label: '选股', to: '/screening', icon: ScanSearch },
